...
def tab1(main_canvas,Label4):
    ...
    Button5.configure(command=lambda:start_denoising_process())
    ...
    Button5.configure(text='''DENOISING''')

    Button6 = Button(Frame2)
    Button6.place(relx=0.12, rely=0.33, height=45, width=137)
    ...
    Button6.configure(command=lambda:start_contrast_equalized_process())
    ...
    Button6.configure(wraplength=130)
    ...
    Button6.configure(text='''CONTRAST   EQUELISING''')

    Button7 = Button(Frame2)
    Button7.place(relx=0.12, rely=0.41, height=45, width=137)
    ...
    Button7.configure(command=lambda:start_binarizing())
    ...
    Button7.configure(text='''BINARIZING''')

    Button8 = Button(Frame2)
    Button8.place(relx=0.12, rely=0.49, height=45, width=137)
    ...
    Button8.configure(command=lambda:skew_correction())
    ...
    Button8.configure(text='''SKEW CORRECT''')
    ...
    Button9.configure(command=lambda:removing_preprinted_lines())
    ...
    Button9.configure(text='''REMOVE PREPRINTED''')

    Button10 = Button(Frame2)
    Button10.place(relx=0.12, rely=0.65, height=45, width=137)
    Button10.configure(activebackground="#1e1e1e")
    Button10.configure(activeforeground="white")
    Button10.configure(activeforeground="#ffffff")
    Button10.configure(background="#232323")
    Button10.configure(command=lambda:line_segmentation())
    Button10.configure(compound='left')
    Button10.configure(disabledforeground="#a3a3a3")
    Button10.configure(font="-family {Arial} -size 10 -weight bold ")
    Button10.configure(wraplength=130)
    Button10.configure(foreground="#ffffff")
    Button10.configure(highlightbackground="#d9d9d9")
    Button10.configure(highlightcolor="black")
    Button10.configure(pady="0")
    Button10.configure(text='''SEGMENT LINES''')

    Button11 = Button(Frame2)
    Button11.place(relx=0.12, rely=0.73, height=45, width=137)
    Button11.configure(activebackground="#1e1e1e")
    Button11.configure(activeforeground="white")
    Button11.configure(activeforeground="#ffffff")
    Button11.configure(background="#232323")
    Button11.configure(command=lambda:word_segmentation())
    Button11.configure(compound='left')
    Button11.configure(disabledforeground="#a3a3a3")
    Button11.configure(font="-family {Arial} -size 10 -weight bold ")
    Button11.configure(wraplength=130)
    Button11.configure(foreground="#ffffff")
    Button11.configure(highlightbackground="#d9d9d9")
    Button11.configure(highlightcolor="black")
    Button11.configure(pady="0")
    Button11.configure(text='''SEGMENT WORDS''')

    Button12 = Button(Frame2)
    Button12.place(relx=0.12, rely=0.81, height=45, width=137)
    Button12.configure(activebackground="#1e1e1e")
    Button12.configure(activeforeground="white")
    Button12.configure(activeforeground="#ffffff")
    Button12.configure(background="#232323")
    Button12.configure(command=lambda:character_segmentation())
    Button12.configure(compound='left')
    Button12.configure(disabledforeground="#a3a3a3")
    Button12.configure(font="-family {Arial} -size 10 -weight bold ")
    Button12.configure(wraplength=130)
    Button12.configure(foreground="#ffffff")
    Button12.configure(highlightbackground="#d9d9d9")
    Button12.configure(highlightcolor="black")
    Button12.configure(pady="0")
    Button12.configure(text='''SEGMENT CHARACTERS''')
