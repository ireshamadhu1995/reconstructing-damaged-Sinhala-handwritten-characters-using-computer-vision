...
def tab2(main_canvas,Label4):
    for widget in main_canvas.winfo_children():
        widget.destroy()
    Label4.configure(text='''L4 Project - Pixels (Module 02)''')
    print("this is tab 2")
    ...
    def upload_file():
        global file_list,upload_imgs,index,result_imgs,is_result_got,logs
        global Label5,part_index
        ...
        boundaries_logs.clear()
        damaged_edges_logs.clear()
        thinning_logs.clear()
        log_text = ""
        text.delete(1.0,END)
        part_index = 0
    ...
    def image_swap_plus():
        global index,upload_imgs,result_imgs,is_result_got,logs,part_index
    ...
    def image_swap_minus():
        global index,result_imgs,upload_imgs,is_result_got,logs,part_index
        if index <= 0:
    ...
    Button2.configure(command=lambda:full_proces2())
    ...
    #Label4.configure(text='''L4 Project - Pixels''')
